...
try:
    ...
    if not openai.api_key:
        raise ValueError(" OPENAI_API_KEY configured.")
...
if __name__ == "__main__":
    ...
    dataset_dir = "/data/dbravoh/VLM/1_dataset_guide/questions/flip"

    RESULTS_ROOT = "/data/dbravoh/VLM/1_dataset_guide/questions/results"  # path for results directory
        ...
        for sub_experiment, data in experiment_plan.items():
            ...
            for i in range(1):  # how many runs ?
                ...
                save_name = os.path.join(
                    RESULTS_ROOT, exp, "gpt4o", results_file_name)
